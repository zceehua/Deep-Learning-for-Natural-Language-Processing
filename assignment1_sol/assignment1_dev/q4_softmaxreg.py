...
def getSentenceFeature(tokens, wordVectors, sentence):
    ...
    ### YOUR CODE HERE
    #get the indice of word that appeared in the sentence
...
def softmaxRegression(features, labels, weights, regularization = 0.0, nopredictions = False):
	...
	#prob[range(N), labels] takes the value with indice=lables in the Nth row
	#prob(10,4),prob[range(10), [0,1,3,2,3,2,1,2,3,0]],labels should not be greater than 4(prob.shape[1])
	# the fourth value will be the value in row 3 at index 3
